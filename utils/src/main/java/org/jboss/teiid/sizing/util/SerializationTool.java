...
public class SerializationTool extends AbstractTeiidUtil {

	public SerializationTool(TeiidUtilProperties props, TeiidUtilConsole console) {
		super(props, console, "Serialization Tool");
	}
	...
	public void execute() throws Exception {
		...
		console.serializationIntro();
		
		SerializationValidation validation = new SerializationValidation("exit", "-q");
		while(true) {			
			String input = console.readString(TeiidUtilPlugin.Util.getString("TeiidUtil.Mode.serialization.input"));
